...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'mehedinaeem00@gmail.com')
...
ADMIN_EMAIL = os.getenv('ADMIN_EMAIL', 'mehedinaeem00@gmail.com')

# Default from email
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'mehedinaeem00@gmail.com')
