...
const navItems = [
    ...
    { name: 'Goals', path: '/admin/goals', icon: HiAcademicCap },
    { name: 'Progress', path: '/admin/progress', icon: HiCollection },
    { name: 'Activities', path: '/admin/activities', icon: HiClipboardList },
    { name: 'Learning', path: '/admin/learning', icon: HiLightBulb },
    { name: 'Travel', path: '/admin/travel', icon: HiCalendar },
